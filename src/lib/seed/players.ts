...
export const GIBBS_ROSTER: { slot: string; slotIndex: number; player: SeedPlayer }[] = [
  ...
  { slot: 'WR', slotIndex: 1, player: { name: 'Jaylen Waddle', position: 'WR', team: 'MIA', archetype: 'WR1', usageMod: 0.96, depthChartOrder: 1, depthChartRole: 'Z receiver' } },
  ...
  { slot: 'FLEX', slotIndex: 0, player: { name: 'Christian Watson', position: 'WR', team: 'GB', archetype: 'WR3', usageMod: 0.95, depthChartOrder: 2, depthChartRole: 'Field stretcher', note: 'Boom/bust deep role; snap count still climbing back.' } },
  ...
  { slot: 'BENCH', slotIndex: 0, player: { name: 'Jaylen Warren', position: 'RB', team: 'PIT', archetype: 'RB2', usageMod: 1.05, depthChartOrder: 1, depthChartRole: 'Committee back' } },
